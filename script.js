...
const fetchMovies1 = async () => {
  const url = `${tmdbCommand}/movie/now_playing?api_key=f807c5e064ea66e2a26f87b6053a5f59&language=ko-kr&page=1`;
  const response = await fetch(url);
  const { results } = await response.json();
  return results;
};
const fetchMovies2 = async () => {
  const url = `${tmdbCommand}/movie/upcoming?api_key=f807c5e064ea66e2a26f87b6053a5f59&language=ko-kr&page=1`;
  const response = await fetch(url);
  const { results } = await response.json();
  return results;
};
